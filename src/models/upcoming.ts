import TopMovie from './top_movie';

const upComingTitles: TopMovie[] = [
  {
    adult: false,
  ...
  {
    adult: false,
    backdrop_path: '/s3ioaDU8OudHWeg7rIbLyU33iXs.jpg',
    genre_ids: [80, 53, 28],
    id: 1047373,
    original_language: 'en',
  ...
  {
    adult: false,
    backdrop_path: '/8y9mgkTlaEUAtjrHr9akapFd6hQ.jpg',
    genre_ids: [27, 9648, 36],
    id: 931944,
    original_language: 'de',
    original_title: 'Des Teufels Bad',
    overview:
    ...
    popularity: 341.581,
    poster_path: '/ycoXsJomPmPjtCfNweM0UWiTkPY.jpg',
  ...
  },
  {
    ...
    popularity: 258.888,
    poster_path: '/18JtlGavtQRxQhJQwgVz6d9PeH3.jpg',
  ...
  {
    adult: false,
    backdrop_path: '/cnUpZo6sNTdfbFx7ufs7ubi5MWX.jpg',
    ...
    popularity: 242.28,
    poster_path: '/xXz6ScxPlLRzL3MtzceNY52Neuq.jpg',
